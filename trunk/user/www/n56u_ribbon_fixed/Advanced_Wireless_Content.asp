...
<div class="wrapper">
    ...
    <input type="hidden" name="wl_pmf" value="<% nvram_get_x("","rt_pmf"); %>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="wl_auth_mode" class="input" onChange="return change_common_wl(this, 'WLANConfig11a', 'wl_auth_mode');">
                                                    ...
                                                    <option value="psk" <% nvram_double_match_x("", "rt_auth_mode", "psk", "", "wl_wpa_mode", "5", "selected"); %>>WPA3-Personal</option>
                                                    <option value="psk" <% nvram_double_match_x("", "wl_auth_mode", "psk", "", "wl_wpa_mode", "0", "selected"); %>>WPA-Auto-Personal</option>
                                                    <option value="psk" <% nvram_double_match_x("", "rt_auth_mode", "psk", "", "wl_wpa_mode", "6", "selected"); %>>WPA2-WPA3-Mixed</option>
